...
export default function Forecast() {
  ...
  const { data, loading, error, isFirstLoad } = useApi<ForecastData>(url);
  ...
  return (
    ...
    >
      {(forecastData) => {
        const { summary, scenarios, historical, forecast } = forecastData;
                ...
                <ComposedChart data={chartData}>
                  <defs>
                    <linearGradient id="forecastConfidence" x1="0" y1="0" x2="0" y2="1">
                      <stop offset="5%" stopColor={colors.chart.primary} stopOpacity={0.15} />
                      <stop offset="95%" stopColor={colors.chart.primary} stopOpacity={0.02} />
                    </linearGradient>
